  ...
  return (
    <section className="border-t border-neutral-200">
      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-10 py-14 lg:py-20">
        ...
        >
          <BrowserWindow title="Active medications">
            ...
            {meds.map((m, i) => (
              <div
                key={m.name}
                className={cn(
                  "med-row grid grid-cols-[1.2fr_1fr_1fr_0.6fr_0.8fr_0.6fr] items-center gap-2 px-5 py-3.5",
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-px border border-neutral-200">
          {correlations.map((cor, i) => (
            <div
              key={cor.metric}
              className={cn(
                "med-row bg-white p-5",
                i < correlations.length - 1 &&
              ...
              <div className="mt-3 h-px bg-neutral-100 overflow-hidden">
                <div
                  ...
                  style={{
                    ...
                    opacity: 0.3,
                    animation: "medConnector 1s ease-out forwards",
