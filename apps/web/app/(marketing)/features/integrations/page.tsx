...
import { GetStartedCard } from "@/features/marketing/components/get-started-card";
...
const providers: Provider[] = [
  ...
  },
  {
    id: "apple-watch",
    name: "Apple Watch",
    description: "Heart rate, activity, sleep, and ECG data",
    category: "Wearables",
    icon: Watch,
    brandIcon: appleIcon,
    color: "text-rose-600",
  ...
  },
  {
    id: "apple-health",
    name: "Apple Health",
    description: "Centralized health data from all your Apple devices",
    category: "Platforms",
    icon: Heart,
    brandIcon: appleIcon,
    color: "text-pink-600",
  ...
  },
  {
    id: "epic-mychart",
    name: "Epic MyChart",
    description: "Medical records and visit summaries from Epic providers",
...
const steps = [
  {
    ...
    description:
      "Browse our integration catalog and pick from wearables, health platforms, lab services, or medical records systems.",
    icon: Activity,
  },
  {
    number: "02",
    ...
    description:
      "Sign in through the provider's own OAuth flow. We never see or store your password — only a scoped access token.",
    icon: Shield,
  },
  {
    number: "03",
    ...
    description:
      "Data flows in automatically. Sync on demand or let OpenVitals pull new observations on a schedule.",
    icon: RefreshCw,
  },
  {
    number: "04",
    ...
    description:
      "View trends, compare metrics across sources, and get AI-powered insights — all from a single dashboard.",
    icon: BarChart3,
  },
];
    ...
    <div className="border border-neutral-200 bg-white p-4 transition-colors hover:border-neutral-900">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          <h3 className="font-display text-[14px] font-medium text-neutral-900">
            {provider.name}
          </h3>
          <p className="font-display text-[12px] text-neutral-500 mt-0.5 line-clamp-1">
      ...
      <div className="flex flex-wrap gap-1 mt-3">
        {provider.dataTypes.map((type) => (
          <span
            key={type}
            className="border border-neutral-200 bg-neutral-50 px-2 py-0.5 font-mono text-[9px] font-bold uppercase tracking-[0.04em] text-neutral-500"
          >
            {type}
          </span>
        ))}
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <section className="mx-auto max-w-[1280px] px-6 md:px-10 pt-20 md:pt-28 pb-14 md:pb-20">
        <div className="max-w-2xl">
          <CubeBadge className="mb-8">Integrations</CubeBadge>
          ...
          <p className="mt-6 font-mono text-[14px] text-neutral-400 leading-[1.65] max-w-lg">
            OpenVitals integrates with the wearables, health platforms, lab
            services, and medical records systems you already use. One dashboard
      ...
      <section className="border-t border-neutral-200">
        <div className="mx-auto max-w-[1280px] px-6 md:px-10 py-14 lg:py-20">
          <CubeBadge className="mb-3">Supported Integrations</CubeBadge>
          ...
          <p className="mt-4 font-mono text-[14px] text-neutral-400 leading-[1.65] max-w-lg">
            From wrist-worn wearables to hospital EHR systems — connect the
            sources that matter to you.
          </p>
          ...
          {(
            ...
            return (
              <div key={cat} className="mt-8 first:mt-10">
                <div className="font-mono text-[10px] font-bold uppercase tracking-[0.08em] text-neutral-400 mb-3">
                  {cat}
                </div>
              ...
              return (
                <div
                  ...
                  className={cn(
                    "pb-8 md:pb-0",
                    i > 0 &&
                      "border-t md:border-t-0 md:border-l border-neutral-800 pt-8 md:pt-0 md:pl-8",
                    i < steps.length - 1 && "md:pr-8",
                  )}
                >
                  <div className="font-mono text-[11px] font-bold text-accent-400 mb-3">
                    {step.number}
                  </div>
                  <div className="size-8 border border-neutral-700 flex items-center justify-center mb-3">
                    <Icon className="h-4 w-4 text-neutral-400" />
                  </div>
                  <h3 className="font-mono text-[13px] font-bold uppercase tracking-[0.06em] text-white mb-2">
                    {step.title}
                  </h3>
            ...
            {[
              {
                ...
                desc: "We use industry-standard OAuth flows. Your provider credentials never touch our servers — only scoped tokens with minimum required permissions.",
              },
              {
              ...
              >
                <div className="font-mono text-[10px] font-bold uppercase tracking-[0.08em] text-accent-500 mb-2">
                  Security
                </div>
                <h4 className="font-display text-[15px] font-medium text-neutral-900 tracking-[-0.01em] leading-snug">
                  {item.title}
                </h4>
                <p className="mt-2 font-display text-[13px] leading-[1.6] text-neutral-500">
                  {item.desc}
                </p>
              </div>
            ))}
