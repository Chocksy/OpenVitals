  ...
  return (
    <div>
      <TitleActionHeader
        ...
        subtitle="Upload lab reports, health records, or data exports to process and analyze."
      />
      ...
      >
        ...
        <p className="mt-2 text-[11px] text-neutral-400 font-mono">
          PDF, CSV, JPEG, PNG, JSON — up to 50MB
        </p>
      </div>
          ...
          {confirmReprocess ? (
            <>
              <span className="text-xs text-neutral-500">
                This will reprocess all documents with the latest parsing logic.
